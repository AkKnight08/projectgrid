  ...
  return (
    <>
      ...
      >
        ...
        {/* Logo / Title */}
        <div className="flex items-center h-full w-[250px] px-6">
          <Link
            to="/"
          ...
          >
            <span className="relative">
              Plan
              <span className="text-white/80 italic font-normal">Pro</span>
              <span className="absolute bottom-[-4px] left-0 w-0 h-0.5 bg-white transition-all duration-200 group-hover:w-full" />
            </span>
          </Link>
        </div>

        {/* Search Bar and Right Section Container */}
        <div className="flex-1 flex items-center px-6 ml-[250px]">
          {/* Search Bar */}
