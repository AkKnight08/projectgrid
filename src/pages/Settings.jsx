...
const Settings = () => {
  ...
  return (
    <div className="h-full">
      {/* Page Title */}
      <h1 className="text-[1.5rem] font-semibold text-white mb-4">Settings</h1>

      {/* Breadcrumbs */}
      <div className="text-[0.875rem] text-textMuted mb-6">
      ...
      <div className="flex gap-6">
        {/* Tab Navigation */}
        <div className="w-[200px] bg-slateDark rounded-lg p-4 flex flex-col gap-2">
          {tabs.map(tab => {
            const Icon = tab.icon
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-4 py-3 text-[0.875rem] font-medium rounded-md transition-colors
                  ${isActive 
                    ? 'bg-[#3B3B5A] text-white border-l-4 border-accentBlue -ml-1' 
                    : 'text-textSecondary hover:bg-[#3A3A4F] hover:text-white'
                  }`}
              >
                <Icon className={`h-5 w-5 ${isActive ? 'text-accentBlue' : 'text-textMuted'}`} />
                {tab.name}
              </button>
            )
          })}
        ...
        {/* Tab Panels */}
        <div className="flex-1 bg-slateDark rounded-lg p-6">
          {activeTab === 'general' && (
            <div role="tabpanel" aria-labelledby="tab-general" className="space-y-6">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="workspaceName" className="block text-sm font-medium text-textSecondary mb-1">
                      Workspace Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-[#2A2A3B] border border-[#3A3A4F] rounded-md text-textPrimary px-4 py-2 text-sm
                        focus:border-accentBlue focus:ring-2 focus:ring-accentBlue/30 focus:outline-none"
                    />
                  </div>
                  <div>
                    <label htmlFor="workspaceUrl" className="block text-sm font-medium text-textSecondary mb-1">
                      Workspace URL
                    </label>
                    <div className="flex gap-2">
                      <input
                        ...
                        readOnly
                        className="flex-1 bg-[#2A2A3B] border border-[#3A3A4F] rounded-md text-textMuted px-4 py-2 text-sm cursor-not-allowed"
                      />
                      <button className="px-4 py-2 bg-accentBlue text-white rounded-md hover:bg-[#2563EB] transition-colors">
                        Copy
                      </button>
                    </div>
                  </div>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="language" className="block text-sm font-medium text-textSecondary mb-1">
                      Primary Language
                    </label>
                    <select
                      id="language"
                  ...
                  <div>
                    <label htmlFor="timezone" className="block text-sm font-medium text-textSecondary mb-1">
                      Timezone
                    </label>
                    <select
                      id="timezone"
              ...
              <div className="flex justify-end">
                <button className="px-6 py-3 bg-accentBlue text-white font-semibold rounded-md hover:bg-[#2563EB] transition-colors">
                  Save Changes
                </button>
              </div>
            </div>
            ...
            <div role="tabpanel" aria-labelledby="tab-account" className="space-y-6">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="displayName" className="block text-sm font-medium text-textSecondary mb-1">
                      Display Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 bg-[#2A2A3B] border border-[#3A3A4F] rounded-md text-textMuted px-4 py-2 text-sm cursor-not-allowed"
                      />
                      <button className="px-4 py-2 text-accentBlue hover:text-[#2563EB] transition-colors text-sm">
                        Change Email
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="h-16 w-16 rounded-full border-2 border-[#3A3A4F] bg-accentBlue flex items-center justify-center text-white text-xl font-medium">
                        U
                      </div>
                      <div className="flex gap-2">
                        <button className="px-4 py-2 bg-accentBlue text-white rounded-md hover:bg-[#2563EB] transition-colors text-sm">
                          Upload Photo
                        </button>
                        <button className="px-4 py-2 text-accentRed hover:text-[#991B1B] transition-colors text-sm">
                          Remove
                        </button>
                      </div>
                    </div>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="currentPassword" className="block text-sm font-medium text-textSecondary mb-1">
                      Current Password
                    </label>
                    <input
                      type="password"
                  ...
                  <div>
                    <label htmlFor="newPassword" className="block text-sm font-medium text-textSecondary mb-1">
                      New Password
                    </label>
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-[#2A2A3B] border border-[#3A3A4F] rounded-md text-textPrimary px-4 py-2 text-sm
                          focus:border-accentBlue focus:ring-2 focus:ring-accentBlue/30 focus:outline-none"
                      />
                      <button className="absolute right-3 top-1/2 -translate-y-1/2 text-textMuted hover:text-white">
                        👁️
                      </button>
                    </div>
                    {/* Password Strength Indicator */}
                    <div className="mt-2">
                      <div className="h-2 bg-[#3A3A4F] rounded-full overflow-hidden">
                        <div className="h-full w-1/3 bg-accentRed"></div>
                      </div>
                      <span className="text-xs text-accentRed mt-1">Weak</span>
                    </div>
                  </div>
                  <div>
          ...
          {activeTab === 'appearance' && (
            <div role="tabpanel" aria-labelledby="tab-appearance" className="space-y-6">
              {/* Theme Selection */}
              <section>
                <h2 className="text-lg font-semibold text-white mb-4">Theme Selection</h2>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 p-4 rounded-md border transition-colors
                        ${theme.id === 'dark'
                          ? 'bg-[#3B3B5A] border-accentBlue text-white'
                          : 'bg-[#2A2A3B] border-[#3A3A4F] text-textSecondary hover:bg-[#3A3A4F] hover:text-white'
                        }`}
                    >
              ...
              <section>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-textSecondary">12pt</span>
                    <span className="text-sm text-textSecondary">18pt</span>
                  </div>
                  <input
                    type="range"
                    min="12"
                    max="18"
                    defaultValue="14"
                    className="w-full h-2 bg-[#3A3A4F] rounded-full appearance-none cursor-pointer
                      [&::-webkit-slider-thumb]:appearance-none
                      [&::-webkit-slider-thumb]:w-4
                      [&::-webkit-slider-thumb]:h-4
                      [&::-webkit-slider-thumb]:rounded-full
                      [&::-webkit-slider-thumb]:bg-accentBlue
                      [&::-webkit-slider-thumb]:shadow-lg
                      [&::-webkit-slider-thumb]:transition-transform
                      [&::-webkit-slider-thumb]:hover:scale-110"
                  />
                  <div className="text-center">
                    <span className="text-sm text-textSecondary">Current: 14pt</span>
                  </div>
                </div>
              </section>
              ...
              {/* Sidebar Position */}
              <section>
                <h2 className="text-lg font-semibold text-white mb-4">Sidebar Position</h2>
          ...
          {activeTab === 'notifications' && (
            <div role="tabpanel" aria-labelledby="tab-notifications" className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between">
                      <span className="text-sm text-textSecondary">{notification}</span>
                      <button
                        role="switch"
                        aria-checked="true"
                      ...
                      >
                        ...
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                            index === 0 ? 'translate-x-4' : 'translate-x-1'
                          }`}
                        />
                      </button>
                    </div>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-4">In-App Notifications</h2>
                <div className="space-y-4">
                  {[
          ...
          {activeTab === 'integrations' && (
            <div role="tabpanel" aria-labelledby="tab-integrations" className="space-y-6">
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-textSecondary">{app.name}</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium ${
                            app.status === 'connected'
                              ? 'bg-accentGreen text-[#0F172A]'
                        ...
                        <button
                          className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                            app.status === 'connected'
                              ? 'bg-accentRed text-white hover:bg-[#991B1B]'
                              : 'bg-accentBlue text-white hover:bg-[#2563EB]'
                          }`}
                        >
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-[#2A2A3B] border border-[#3A3A4F] rounded-md">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-textSecondary">Your API Key:</span>
                      <span className="text-sm text-textPrimary">••••-••••-ABCD</span>
                    </div>
                    <div className="flex items-center gap-2">
          ...
          {activeTab === 'billing' && (
            <div role="tabpanel" aria-labelledby="tab-billing" className="space-y-6">
              ...
              <section>
                ...
                <div className="space-y-2">
                  <p className="text-sm text-textSecondary">
                    Current Plan: <span className="text-white font-medium">Pro</span>
                  </p>
                  <p className="text-sm text-textSecondary">
                    Next Billing Date: <span className="text-white">Jul 15, 2025</span>
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex flex-col p-6 bg-[#2A2A3B] border border-[#3A3A4F] rounded-lg"
                    >
                      <h3 className="text-lg font-semibold text-white mb-2">{plan.name}</h3>
                      <p className={`text-2xl font-bold mb-4 ${plan.current ? 'text-accentBlue' : 'text-textMuted'}`}>
                        {plan.price}<span className="text-sm font-normal text-textSecondary">/month</span>
                      </p>
                      ...
                      <button
                        className={`mt-auto px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                          plan.current
                            ? 'bg-[#3A3A4F] text-textMuted cursor-not-allowed'
                            : 'bg-accentBlue text-white hover:bg-[#2563EB]'
                        }`}
                      >
              ...
              <section>
                ...
                <div className="flex items-center justify-between p-4 bg-[#2A2A3B] border border-[#3A3A4F] rounded-md">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-16 rounded bg-[#3A3A4F] flex items-center justify-center">
                      💳
                    </div>
                    <span className="text-sm text-textSecondary">Card ending in 1234</span>
                  </div>
                  <button className="px-4 py-2 bg-accentAmber text-[#0F172A] rounded-md hover:bg-[#D97706] transition-colors text-sm">
                    Update Card
                  </button>
